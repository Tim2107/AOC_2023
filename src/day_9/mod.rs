...
use crate::day_9::sequence_analysis::{analyze_and_predict_next_numbers, analyze_and_predict_preceeding_numbers, sum_of_predictions};
use anyhow::{Result};
...
pub fn solve_day_9() -> Result<(i32,i32)> {
    ...
    let extrapolated_preceding_numbers = analyze_and_predict_preceeding_numbers(&sequences);
